...
absl::StatusOr<FlatExpression> FlatExprBuilder::CreateExpressionImpl(
  ...
  FlatExprVisitor visitor(
      resolver, options_, std::move(optimizers), ast->reference_map(),
      ast->type_map(), GetTypeProvider(), issue_collector, program_builder,
      extension_context, enable_optional_types_);
